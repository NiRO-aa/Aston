...
public class Starter {
    public static void main(String[] args) {
        ...
        students.add(new Student("Смирнова Алина", 15, new ArrayList<>(List.of(
        ...
        students.add(new Student("Козлов Артём", 17,new ArrayList<>(List.of(
        ...
        students.add(new Student("Петрова София", 16, new ArrayList<>(List.of(
        ...
        students.add(new Student("Николаев Максим", 14, new ArrayList<>(List.of(
        ...
        students.add(new Student("Фёдорова Виктория", 15, new ArrayList<>(List.of(
                new Book("1984", "Джордж Оруэлл", 1949, 328),
